...
export class PaymentIntentDto extends BaseDto {
  ...
  @ApiProperty({
    description:
      "For non-card charges, you can use this value as the complete description that appears on your customer's statements. Must contain at least one letter, maximum 22 characters.",
  })
